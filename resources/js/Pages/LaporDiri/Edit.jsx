...
const LaporDiriEdit = ({ uuid }) => {
    ...
    async function SaveBerkasHandler() {
        ...
        try {
            ...
            const response = await apiProduction.post(
                "/api/save-berkas",
                formData,
                {
                    headers: {
            ...
            if (status === 400) {
                ...
                if (
                    ...
                    "berkasTambahan.invalidValidation"
                ) {
                    ...
                    >
                        ...
                        <ol className="list-decimal pl-10">
                            <li>
                                ...
                                lalu di Scan){" "}
                                <a
                                    href="https://lapordiri-ppg.unpak.ac.id/FAKTA%20INTEGRITAS%20.pdf"
                    ...
                    >
                        ...
                        <ol className="list-decimal pl-10">
                            <li>
                                ...
                                <a
                                    href="https://lapordiri-ppg.unpak.ac.id/Biodata%20Mahasiswa%20PD%20DIKTI.pdf"
                                    class="hover:bg-gray-700 hover:text-white text-purple-600 rounded-md px-3 py-2 text-sm font-medium"
                                >
                                    Klik Disini
                                </a>
                        ...
                        {transkripS1 && (
                            <div className="bg-purple-50 border border-purple-400 rounded text-purple-800 text-sm p-2 flex justify-between">
                                <div>
                                    <div className="flex items-center">
                                        <p>
                                            {transkripS1Preview ?? transkripS1}
                                        </p>
                                    </div>
                                </div>
