            ...
            return LaporDiri::select("pendaftaran.*","mahasiswa.nama")->join("mahasiswa", "pendaftaran.nomorUKG", "mahasiswa.nomorUKG")->where('status', $this->filter_status)->get()
                    ->map(function($mahasiswa) use($isDev){
                        return [
                            ...
                            empty($mahasiswa->foto)?                            "" : ($isDev? asset('foto/' . $mahasiswa->foto)                                                         : secure_asset('transkripS1/' . $mahasiswa->foto)),
                            empty($mahasiswa->ktp)?                             "" : ($isDev? asset('ktp/' . $mahasiswa->ktp)                                                           : secure_asset('transkripS1/' . $mahasiswa->ktp)),
