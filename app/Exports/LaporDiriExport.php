            ...
            return LaporDiri::where('status', $this->filter_status)->get()
                    ->map(function($mahasiswa) use($isDev){
                        return [
                            ...
                            empty($mahasiswa->foto)?                            "" : ($isDev? asset('foto/' . $mahasiswa->foto)                                                         : secure_asset('transkripS1/' . $mahasiswa->transkripS1)),
                            empty($mahasiswa->ktp)?                             "" : ($isDev? asset('ktp/' . $mahasiswa->ktp)                                                           : secure_asset('transkripS1/' . $mahasiswa->transkripS1)),
